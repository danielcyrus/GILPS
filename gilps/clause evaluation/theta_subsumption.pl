...
% GILPS modules
:- use_module('../bottom clause/bottom_clause', [ground_sat/4,ground_sat/1]). %to compute the ground bottom clause from one example
...
load_example(ExampleAtom, Weight, ExampleID):-
  ...
  ,ground_sat(ExampleID) % Note: DC: this line could be comment, it shows the generated clauses
  . 

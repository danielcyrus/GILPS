...
% Second Author: Daniel Cyrus <d.cyrus@surrey.ac.uk>                                   %
% Date: 2022-09-20                                                                     %
...
welcome:-
  ...
  format('Developers: Daniel Cyrus~nDr Alireza Tamaddoni Nezhad'),
  format('For more information please check: ~w~2n', [WebPage]).

gilps_version('1.1').
gilps_version_date('20th September 2022').
gilps_webpage('https://github.com').
